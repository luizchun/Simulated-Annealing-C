                  ...
                  if ((finalpontuacaosalas(ii,1)==jj && finalpontuacaosalas(ii,2)-1==oo(ll)) )#|| (finalpontuacaoprofessores(fft,1)==jj && finalpontuacaoprofessores(fft,2)-1==oo(ll)))
                          ...
                          aux11=solucaoinicial(jj,oo(ll)-1:oo(ll)+1);
                             if mod(jj,2)==0 
                                ...
                                if solucaoinicial(jj,oo(ll))~= -1 && solucaoinicial(jj,oo(aa))~= -1
                                  solucaoinicial(jj,oo(ll)-1:oo(ll)+1)=solucaoinicial(jj,oo(aa)-1:oo(aa)+1);
                                  solucaoinicial(jj,oo(aa)-1:oo(aa)+1)=aux11;
                                endif  
